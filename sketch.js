var helicopterIMG, helicopterSprite, packageSprite,BottomSprite,leftSprite,rightSprite,packageIMG;
...
function setup() {
	...
	//Bottom Box
	BottomBox=Bodies.rectangle(400,630,200,20,{isStatic:true});
	World.add(world,BottomBox);
  //LeftSide
  LeftBox=Bodies.rectangle(300,590,20,100,{isStatic:true});
  World.add(world,LeftBox);
   //RightSide
   RightBox=Bodies.rectangle(300,590,20,100,{isStatic:true});
